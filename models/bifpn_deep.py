...
class BiFpnDeep(BaseModel):
    ...
    def create_decoder(self, backbone, skips):
        ...
        P1, P2, P3, P4, P5 = BiFpnDeepLayer(
            stage1, stage2, stage3, stage4, stage5, filters=64, conv_input=True, name="BiFpn_0_")
        P1, P2, P3, P4, P5 = BiFpnDeepLayer(
            P1, P2, P3, P4, P5, filters=64, conv_input=True, name="BiFpn_1_")
        P1 = BiFpnDeepLayer(
            P1, P2, P3, P4, P5, filters=64, conv_input=True, has_bottomup=False, name="BiFpn_2_")
