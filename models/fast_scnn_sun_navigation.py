...
class FastScnnSunNavigation(BaseModel):
    ...
    def build_model(self):
        ...
        gfe4 = ppm_block(gfe3, [2, 4, 6, 8], 23, 17, 128)
        print(gfe4.shape)
        ...
        class3 = resize_img(class2, H=self.config.model.height, W=self.config.model.width)
        print(class3.shape)
        ...
        metrics = self.build_metrics_navigation()
