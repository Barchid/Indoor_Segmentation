...
class FpnBaseStage2(BaseModel):
    def __init__(self, config, datagen):
        super(FpnBaseStage2, self).__init__(config, datagen)
    ...
    def create_decoder(self, backbone, skips):
        ...
        merge = merge_block(fusion4, fusion3, fusion2, stage2,
...
def merge_block(fusion4, fusion3, fusion2, stage2, out_channels):
