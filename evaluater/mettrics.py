import evaluater.functional as F
from tensorflow import keras

# FROM https://github.com/qubvel/segmentation_models/blob/a6fbf2d5ea21081929df634d095d389211e649ef/segmentation_models/metrics.py
...
class IOUScore(keras.metrics.Metric):
    ...
    def __init__(
        ...
        super(IOUScore).__init__(name=name, **kwargs)
...
class Precision(keras.metrics.Metric):
    ...
    def __init__(
        ...
        super(Precision).__init__(name=name, **kwargs)
        self.class_weights = class_weights if class_weights is not None else 1
        self.class_indexes = class_indexes
        self.threshold = threshold
        self.per_image = per_image
